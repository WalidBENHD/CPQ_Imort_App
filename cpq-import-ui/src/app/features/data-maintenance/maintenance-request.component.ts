...
export class MaintenanceRequestComponent implements OnInit {
  ...
  loadError = false;
  acting = false;
  workflowAction: 'publish' | null = null;
  showDecision = false;
  decisionReason = '';
  ...
  private run(action: Observable<unknown>, success: string, workflowAction: 'publish' | null = null): void {
    this.acting = true;
